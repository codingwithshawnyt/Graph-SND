...
\item {\bf Claims}
    ...
    Gaussian policies, single DiCo set point) are stated in
...
\item {\bf Theory assumptions and proofs}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: All six formal results
    (Propositions~\ref{prop:recovery}--\ref{prop:unbiased} and
    Theorem~\ref{thm:concentration}) are stated with their
    assumptions in Sections~\ref{sec:method}--\ref{sec:theory} and
    proved in full in Appendix~\ref{app:proofs}. Assumptions (e.g.,
...
\item {\bf Experimental result reproducibility}
    ...
    random graph. Everything needed to reconstruct the code paths is
...
\item {\bf Experimental setting/details}
    ...
    $128$-env subsample used for the $k$-NN construction.
...
\item {\bf Experiments compute resources}
    ...
    under $24$ GPU-hours on one RTX~4090 plus a few CPU-hours for
