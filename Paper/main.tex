...
$|E|{=}\Theta(n\log n)$, delivering a deterministic near-linear-cost
approximation of an $\mathcal{O}(n^2)$ metric}.
...
empirically; however, distribution-dependent sharpenings of the
worst-case $\mathcal{O}(\log n)$ bound remain untested.
...
Theorem~\ref{thm:distortion}; and (iv) a broader DiCo$+\SNDG$ study, over larger $n$, tasks,
