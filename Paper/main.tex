...
We validate the four core claims (Theorem~\ref{thm:distortion} is a
deterministic structural bound proved in Appendix~\ref{app:proofs}; it
is not part of the empirical validation below) of
