...
ordering persists on a trained $n{=}100$ checkpoint. On VMAS Dispersion at $n{=}10$, substituting either a $k{=}3$ $k$-NN
graph or a Bernoulli-$0.1$ random subgraph for full SND inside the
DiCo diversity controller matches the $\SND_{\mathrm{des}}{=}0.1$
set point to within $10^{-3}$ and matches full-$\SND$ reward within
seed variance; a paired three-seed, three-set-point head-to-head at
...
variance at reduced per-call cost, extended at $n{=}50$ to a
