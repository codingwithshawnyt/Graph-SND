...
discrepancy bound under nuclear-norm control of the distance matrix. VMAS
experiments verify recovery, unbiasedness, concentration, and wall-clock
scaling, while a PettingZoo TVD panel checks non-Gaussian transfer. In a
500-iteration $n=100$ PPO run,
...
spectral nuclear-norm refinement. (iii) VMAS experiments
