...
sampled edge count. For fixed sparse graphs, we prove a distortion bound
controlled by the edge forwarding index, giving $O(\log n)$ worst-case
distortion for expanders with $\Theta(n\log n)$ edges. Experiments on
...
matched cells) at a measured $9.25$--$9.63\times$ lower per-call metric
